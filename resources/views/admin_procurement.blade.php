            ...
            @elseif ($datanya->status_notifikasi === "belum_dilihat")                    
                    <div class="card">
                        <div class="card-header">
                            Notifikasi - ID Proactive: <b>{{ $datanya->id_proactive }}</b>
                        </div>
                        <div class="card-body">
                            <h5 class="card-title">{{ $datanya->id_proactive }}</h5>
                            ...
                            {{ csrf_field() }}
                                ...
                                <input type="hidden" name="id_proactive" value="{{ $datanya->id_proactive }}" />
